...
const About = () => {
    return (
       ...
       <section className=" Trio-Bangla w-full mx-auto py-10 bg-gray-50 dark:bg-gray-900 dark:text-white">
...
# আশা সবাই গ্রুপের কাজ এতক্ষণে বুঝে গেছেন।  তো আর দেরি কিসের আমদের উদ্যোগটি যদি আপনার ভালো লেগে থাকে তাহলে আপনার বন্ধুদের ইনভাইট করতে পারেন।মনে রাখবেন যাদের ইনভাইট করবেন তারাও যেন আমাদের উদ্যোগ এ সামিল হতে পারেন!!

#আর গ্রুপে সবাই খারাপ কোন পোস্ট করবেননা। কোন রাজনৈতিক দলের পোস্ট না দেওয়াই ভালো।ধর্ম নিয়ে তর্ক করবেন না।কাউকে গালি বা আপত্তিকর ভাষায় কিছু বলবেন না।অশালীন ভাষায় কোনো মন্তব্য করবেন না।
সামাজিক জীব হিসেবে সৃষ্টিলগ্ন থেকেই মানুষ একসাথে বাস করে আসছে। প্রাণিজগতের অন্যান্য সদস্যদের মতো মানুষও রোগ-ব্যাধিতে আক্রান্ত হয়, ভয়-জরা তাকে গ্রাস করে। মানুষের যত ভয় আছে তার মধ্যে সবচেয়ে বড় ভয় হলো সমাজের ভয়। আমরা কোনকিছু করতে গেলে প্রথমে ভাবি সমাজ কী বলবে, সমাজ কী ভাববে।তাই কে কি বলবে এটা না ভেবে,সমাজের জন্য কিছু করাই সামাজিক দায়বদ্ধতার মধ্যে পড়ে।
তাই আসুন সমাজ থেকে নেতিবাচক জিনিস গুলো বর্জন করি।আর ভালো কিছু নিয়ে সমাজকে এগিয়ে নিয়ে যাই।
</p>
      </div>
