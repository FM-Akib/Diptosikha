...
const BloodCard = (props) => {
     const {name,email,mobile,img,bloodGroup,lastDonatedDate,address}=props.blood;
    ...
    return (
        ...
        <div
            ...
            <span className="absolute text-xs font-medium top-0 left-0 rounded-br-lg rounded-tl-lg px-3 py-2 bg-primary-100 dark:bg-gray-900 dark:text-gray-300 border-gray-400 dark:border-gray-400 border-b-2 border-r-2 border-dashed ">
            {bloodGroup}
            </span>
            ...
            <div className="w-full sm:w-auto flex flex-col items-start sm:items-start">
                ...
                <div className="mb-4 md:text-lg text-gray-400">
                    <p>Last Donated: {lastDonatedDate}</p>
                    <p>Mobile: {mobile}</p>
                    <p>Address: {address}</p>
                    <p>Email: {email}</p>
                </div>
