...
import {faMapLocationDot, faMobileAlt,faEnvelope,faEarthAmericas} from '@fortawesome/free-solid-svg-icons';
...
const Footer = () => {
    ...
    <div className="bg-gray-200 py-4 text-gray-900 md:p-24">
      <div className="container px-4 mx-auto">
        <div className="-mx-4 flex flex-wrap justify-between">
          ...
          <div className="px-4 my-4 w-full sm:w-auto xl:w-1/5">
            ...
            <Link to="https://www.facebook.com/diptasikha.9" className="shadow-lg inline-flex items-center justify-center h-8 w-8 border border-gray-400 rounded-full mr-2 hover:text-blue-400 hover:border-red-600">
