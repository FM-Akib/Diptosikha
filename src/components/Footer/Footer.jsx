...
const Footer = () => {
    return (
        <footer>
    <div className="bg-green-900 py-4 text-sky-50 p-3">
        ...
        <div className="-mx-4 flex flex-wrap justify-between">
                ...
                <g fill="none" fill-rule="evenodd">
                  <g transform="translate(0 -75)">
                    ...
                    <text fill="white" font-family="Nunito-Bold, Nunito" font-size="512" font-weight="bold">
                      <tspan x="654" y="518">Diptosikha</tspan>
                    </text>
                  </g>
                </g>
              </svg>
          ...
          <div className="px-4 my-4 w-full sm:w-auto">
            ...
            <ul className="leading-8">
              ...
              <li><Link to="#" className="hover:text-yellow-400">Terms &amp; Conditions</Link></li>
    ...
    <div className="bg-yellow-600 py-4 text-gray-100">
