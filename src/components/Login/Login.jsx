    ...
    <div className="interFont w-full space-y-6 text-gray-600 sm:max-w-md">
                <div className="text-center">
                    ...
                    <div className="mt-5 space-y-2">
                        <h3 className="text-gray-800 text-3xl font-bold sm:text-3xl">Log in to your account</h3>
                        <p className="">Do not have an account? <Link to="/signup" className="font-medium text-indigo-600 hover:text-indigo-500">Sign up</Link></p>
                    </div>
                </div>
                <div className="bg-white shadow-lg p-4 py-6 space-y-8 sm:p-6 sm:rounded-lg">
                    <div className="grid grid-cols-3 gap-x-3">
                        <button onClick={handleSignInGoogle} className="flex items-center justify-center py-2.5 border rounded-lg hover:bg-gray-50 duration-150 active:bg-gray-100">
                    ...
                    >
                        ...
                        <button 
                            className="w-full px-4 py-2 text-white font-bold text-xl bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-600 rounded-lg duration-150" 
                        >
                            Sign in
                        </button>
                    </form>
